#
#  Be sure to run `pod spec lint PANumberKeyboard.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                   A longer description of PANumberKeyboard in Markdown format.
  ...
  # Or just: s.author    = "Alexey Popkov"
  # s.authors            = { "Alexey Popkov" => "alexey.yu.popkov@gmail.com" }
  # s.social_media_url   = "http://twitter.com/Alexey Popkov"
